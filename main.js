...
// import PalmGenerator from './pg/PalmGenerator.js';
// import LeafGeometry from './pg/LeafGeometry.js';
...
function init() {
	...
	// var particleCount = particleGeometry.attributes.position.length/3;
    ...
    // STARS
    starCount = 150;
    // starX.length = starY.length = starZ.length = starCount;
    rMax = 70;
    rMin = 55;
    var starGeo = new THREE.PlaneGeometry(2, 2, 1, 1);
    var starTexture = new THREE.TextureLoader().load('sticker/star-3.png');
    ...
    // loader.load( "palm.json", function ( object ) {
...
function animate() {
	...
	// for( var v = 0; v < particleGeometry.attributes.position.length/3; v++ ) 
	// {
